...
float4 PS(PSInput input) : SV_TARGET
{
    ...
    float Ripple_out2;
    Ripple(input.uv,1.000000,1.000000,float2(0.000000,0.000000),1.000000,Ripple_out2);

    float VoronoiOut_out1;
    float VoronoiCell_out1;
    float VoronoiLine_out1;
    Voronoi(Twirl_out3,7.000000,7.000000,VoronoiOut_out1,VoronoiCell_out1,VoronoiLine_out1);

    float Multiply_float_out4;
    Multiply_float(VoronoiCell_out1,Ripple_out2,Multiply_float_out4);

    float4 flag_color = Unlit(float4(0.000000,0.000000,0.000000,0.000000),Multiply_float_out4,1.000000,0.000000);
    return flag_color;
}
