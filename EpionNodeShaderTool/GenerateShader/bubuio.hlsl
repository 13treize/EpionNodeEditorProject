...
float4 PS(PSInput input) : SV_TARGET
{
    ...
    float3 Color_out2=float3(0.109564,0.250948,0.887118);
    ...
    float4 flag_color = Unlit(float4(0.000000,0.000000,0.000000,0.000000),Multiply_float3_out3,1.000000,0.000000);
    return flag_color;
}
