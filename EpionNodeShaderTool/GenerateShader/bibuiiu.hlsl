...
float4 PS(PSInput input) : SV_TARGET
{
    ...
    Multiply_float(Sin_Time_,10.000000,Multiply_float_out4);

    float2 Twirl_out2;
    Twirl(input.uv,float2(0.500000,0.500000),Multiply_float_out4,float2(0.000000,0.000000),Twirl_out2);

    float VoronoiOut_out1;
    float VoronoiCell_out1;
    float VoronoiLine_out1;
    Voronoi(Twirl_out2,7.000000,8.000000,VoronoiOut_out1,VoronoiCell_out1,VoronoiLine_out1);
