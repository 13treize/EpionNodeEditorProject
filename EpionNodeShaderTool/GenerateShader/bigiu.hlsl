...
float4 PS(PSInput input) : SV_TARGET
{
    ...
    Voronoi(input.uv,7.000000,4.000000,VoronoiOut_out1,VoronoiCell_out1,VoronoiLine_out1);

    float3 Checkerboard_out2;
    Checkerboard(input.uv,VoronoiCell_out1,float3(0.003984,1.000000,0.547265),float2(1.000000,1.000000),Checkerboard_out2);
