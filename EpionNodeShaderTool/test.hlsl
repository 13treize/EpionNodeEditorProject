...
float4 PS(PSInput input) : SV_TARGET
{
    ...
    float1 VoronoiOut_out1;
    float1 VoronoiCell_out1;
    float1 VoronoiLine_out1;
    Voronoi(input.uv,6.000000,5.000000,VoronoiOut_out1,VoronoiCell_out1,VoronoiLine_out1);
